...
namespace CrmEarlyBound
{
	...
	public partial class Account : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("defra_hierarchylevel")]
		public virtual defra_OrganisationHierarchyLevel? defra_hierarchylevelEnum
		{
			get
			{
				return ((defra_OrganisationHierarchyLevel?)(EntityOptionSetEnum.GetEnum(this, "defra_hierarchylevel")));
			}
			set
			{
				defra_hierarchylevel = value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null;
			}
		}
