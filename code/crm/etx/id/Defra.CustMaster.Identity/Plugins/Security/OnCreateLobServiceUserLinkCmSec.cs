...
{
   public class OnCreateLobServiceUserLinkCmSec : IPlugin
    {
                            ...
                            if (serviceEntity.Attributes.Contains("defra_ownerbu") && serviceEntity.Attributes["defra_ownerbu"] != null)
                            {
                                ...
                                if (serviceBusinessUnit != null)
                                {
                                    ...
                                    if (teamEntity != null)
                                    {
                                        ...
                                        AssignRecordOwner(teamEntity.Id, targetEntity);
        ...
        private void AssignRecordOwner(Guid teamId, Entity targetEntity)
        {
