    ...
    public static class JSONParser
    {
        ...
        static Dictionary<string, T> CreateMemberNameDictionary<T>(T[] members) where T : MemberInfo
        {
            ...
            for (int i = 0; i < members.Length; i++)
            {
                ...
                /*INFO: Code changed by Bilal R, because the DataMemberAttribute.IsNameSetExplicitly is not available in .NET version 4.5.2
                 * Original Code:
                 * if (dataMemberAttribute != null && dataMemberAttribute.IsNameSetExplicitly)
                 * Update Code:
                 * if (dataMemberAttribute != null && dataMemberAttribute.Name != null)
                */
                if (dataMemberAttribute != null && dataMemberAttribute.Name != null)// && dataMemberAttribute.IsNameSetExplicitly)
